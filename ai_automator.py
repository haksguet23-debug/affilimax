...
# Charge le fichier .env du projet s'il existe (cles GROQ_API_KEY,
# AI_MODEL, GEMINI_API_KEY, ...). En production (Render.com) les variables
# sont definies dans Render Dashboard > Environment -> le .env est ignore.
# Utilise python-dotenv si installe, sinon un mini-parseur sans dependance.
def _load_env_file():
